package com.spminfiscaa.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("spminfimscaa");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("spminfimscaa");
        ...
        config.getMapConfigs().put("com.spminfiscaa.domain.*", initializeDomainMapConfig(jHipsterProperties));
